...
<%
	 ...
	 * 17.06.20   김진수        인덱스 페이지 게시글 상세보기 추가
	   17.06.27   김진수        상세보기 - URL 이동 추가, 전체 게시글 갯수 가져오기 추가
						...
						<div class="info-box">
							...
							<div class="info-box-content">
								<span class="info-box-text">총 클라이언트</span> <span
									class="info-box-number">${_clienttot}</span>
								<div class="progress">
						...
						<div class="info-box">
							...
							<div class="info-box-content">
								<span class="info-box-text">작동 중인 클라이언트</span> <span
									class="info-box-number">${working_y}</span>
								<div class="progress">
									<div class="progress-bar" style="width: 100%"></div>
								</div>
								<span class="progress-description"> <i
						...
						<div class="info-box">
							...
							<div class="info-box-content">
								<span class="info-box-text">중지된 클라이언트</span> <span
									class="info-box-number">${working_n}</span>
								<div class="progress">
									<div class="progress-bar" style="width: 100%"></div>
								</div>
